        ...
        <head>
            ...
            <style>
                ...
                * {
                ...
                @media screen {
                    body { zoom: 70%; height: 100%; overflow: hidden; }
                    .page { padding: 8mm; background-color: #fff; border-radius: 10pt; height: 100%; }
                }
        ...
        <body>
            <div class="page">
                ...
                <div class="invoice-infos">
                    <h1 class="title">${isQuote ? 'Devis' : 'Facture'}</h1>
                    <div class="infos">
                        <div class="info">
                            <b>${isQuote ? "DE" : "FA"}-</b>
                            <b id="invoice-number" contentEditable="true" class="editable"
                                onblur="onInvoiceNumberChanged(this)" onkeydown="onInvoiceNumberKeyDown(event)">
                                ${data.invoice_number}
                            </b>
                        </div>
                        <div class="info">
                            <span>Date :&nbsp;</span>
                            <span id="invoice-date" contentEditable="true" class="editable"
                ...
                <div class="order-detail">
                    <table>
                        ...
                        <tr class="detail-commande">
                            <td>
                                <span id="service-name" contentEditable="true" class="editable"
                ...
                <div class="order-detail-footer">
                    <div class="texts">
                        <span>Arrêtée ${isQuote ? 'le présent devis' : 'la présente facture'} au montant hors taxe de :</span>
                        <b style="text-transform: capitalize">${data.price_letters} Dirhams (${data.price} DH)</b>
                        <small>Sont exonérés de la TVA, sans bénéfice du droit à déduction.<br>(article 91 du CGI
                            marocain)</small>
                    </div>
                    <div class="total">
